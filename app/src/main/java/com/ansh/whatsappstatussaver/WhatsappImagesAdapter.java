...
public class WhatsappImagesAdapter extends RecyclerView.Adapter<WhatsappImagesAdapter.ViewHolder> {

    private final ArrayList<WhatsappStatusModel> list;
    private final Context context;
    private final String saveFilePath = RootDirectoryWhatsapp + "/";

    public WhatsappImagesAdapter(ArrayList<WhatsappStatusModel> list, Context context) {
        this.list = list;
